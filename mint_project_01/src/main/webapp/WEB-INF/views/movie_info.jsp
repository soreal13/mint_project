...
<img src="resources/img/M_urlcopy.png" src="url복사"">
       ...
       if(chkF=="Y"){
              %>
              <img src="resources/img/M_like2.png"onclick="location.href='delFollow.do?mseq=${mdto.mseq}&mfollow_sample=${mdto.mfollow}&useq=2'">
              <%
       } else {
              %>
              <img src="resources/img/M_like1.png" onclick="location.href='updateFollow.do?mseq=${mdto.mseq}&mfollow_sample=${mdto.mfollow}&useq=2'">
              <%
       }
       %>
...
<h3>별점주기</h3>
				...
				<form action="updateStarpoint.do" method="post">
						<input type="hidden" name="suseq" value="2">
						<input type="hidden" name="smseq" value="${mdto.mseq}">
				<span class="star-input">
				 ...
				 for(int j=1;j<11;j++){
					 ...
					 <input type="radio" name="star-input" id="p<%=j%>" value="<%=j%>"
					 <%
				  ...
				  <output for="star-input"><b class="star_b">0</b>점</output>
				</span>
				<%
					if(sdto==null){
						%>
