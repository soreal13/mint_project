		...
		<p>한줄평 작성하기</p>
			<table class="review_table">
				...
				<tr>
					...
					<td><textarea rows="3" cols="59" name="rcontent" placeholder="한줄평을 입력해주세요." style="resize: none;"></textarea></td>
	   ...
	   if(i<6){
		  ...
		  %>		 
			<li>
				...
				<p class="mtitle" style="font-size:24px;"><a href="movie_info.do?mseq=<%=tmdto.getMseq()%>&useq=${ldto.useq}"><%=tmdto.getMtitle()%></a></p>				
		 	</li>
		 <%		   
	   	}		   				   
	   }
