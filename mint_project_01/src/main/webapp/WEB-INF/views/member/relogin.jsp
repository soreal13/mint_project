...
<style type="text/css">
   ...
   #o{border:  width: 360px; height: 130px; margin-left: 300px; margin-top: 20px; margin-bottom: 20px;}
...
<h3><font color="orange"> 입력하신 회원정보가 틀렸습니다.</font></h3>
<h3><font color="orange"> 다시 로그인 해주세요.</font></h3>
<table id="o">
   <tr>
      <td><h2>이메일</h2></td>
