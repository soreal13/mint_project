...
<col width="130px;"><col width="160px;"><col width="30px;"><col width="280px;">
      ...
      <tr>
         <td><h3>비밀번호</h3></td>
         <td><input type="password" name="upwd" id="upwd" required="required" class="chkConfirm" onfocus="conform()" autocomplete="off" style="text-align: letter-spacing;width:170px;height: 20px; "/></td>
         <td colspan="2"><input type="text" hidden="hidden" ></td>
         
      </tr>
         <tr>
            <td><h3>비밀번호 확인</h3></td>
            <td><input type="password" name="password" id="pwdchk"  title="nnnn" class="chkConfirm" required="required" onfocus="conform()" autocomplete="off" style="text-align: letter-spacing;width:170px;height: 20px; "/></td>
