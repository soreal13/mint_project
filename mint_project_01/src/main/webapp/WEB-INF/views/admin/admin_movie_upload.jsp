	...
	<form action="movieupload.do" method="post">
		<h3>한줄평 작성하기</h3>
			<table border="1">
				...
				<tr>
					<td>개봉일</td>
					<td><input type="text" name="mshowddate"></td>
				</tr>
				<tr>
					<td>감독</td>
					<td><input type="text" name="mdirector"></td>
				</tr>
				<tr>
					<td>주연배우</td>
					<td><input type="text" name="mactor"></td>
				</tr>
				<tr>
					<td>연령가</td>
					<td>
...
<!-- 						자바스크립트: 여기서 select한걸 읽어서 아래 text에 추가되게 하기  -->
				...
				<tr>
					<td>줄거리</td>
					<td><textarea rows="10" cols="60" name="msummary"></textarea></td>
				</tr>
				<tr>
					<td>MD Pick 여부</td>
					<td>
				...
				<tr>
				<td colspan="2"><input type="submit" value="영화업로드"></td>
				</tr>
